      ...
      <div className="relative bg-gradient-to-br from-white via-white to-blue-50/30 border-b border-gray-200/60 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-12">
          ...
          <motion.p
            ...
            className="text-gray-500 max-w-2xl text-[calc(15px+1.5pt)]"
          >
              ...
              >
                ...
                >
                  <div className="flex-1">
                    <div className="text-[calc(11px+1.5pt)] font-bold text-blue-500 uppercase tracking-widest mb-2">
                      {s.mainHead}
                    </div>
                    <h3 className="text-[calc(15px+1.5pt)] font-semibold text-gray-800 group-hover:text-blue-700 transition-colors leading-snug mb-2">
                      {s.name}
                    </h3>
                    <p className="text-[calc(13px+1.5pt)] text-gray-400 leading-relaxed line-clamp-2">
                      {s.shortDescription || 'Expert assistance for this service — view details to get started.'}
                    </p>
                  </div>
                  <div className="mt-4 flex items-center gap-1.5 text-[calc(12px+1.5pt)] font-semibold text-gray-400 group-hover:text-blue-600 transition-colors">
