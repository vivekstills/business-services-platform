              ...
              >
                ...
                >
                  <div className="flex-1">
                    ...
                    <h3 className="text-[15px] font-semibold text-gray-800 group-hover:text-blue-700 transition-colors leading-snug mb-2">
                      {s.name}
                    </h3>
                  ...
                  <div className="mt-4 flex items-center gap-1.5 text-[12px] font-semibold text-gray-400 group-hover:text-blue-600 transition-colors">
