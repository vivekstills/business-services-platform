    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50/80 via-gray-50 to-white pt-16 noise-overlay">
      <div className="max-w-4xl mx-auto px-6 lg:px-8 py-16">
        ...
        <motion.div
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-[calc(13px+2pt)] text-gray-500">Search by company name or CIN on the official MCA portal</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <input
              ...
              className="flex-1 h-12 rounded-xl border border-gray-200 px-4 text-[calc(15px+2pt)] text-gray-800 placeholder-gray-400 focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100"
            />
            <a
              href={MCA_SEARCH_URL}
              target="_blank"
        ...
        >
          ...
          <p className="text-[calc(14px+2pt)] text-gray-500 mb-4">We help you incorporate a new Private Limited Company, LLP, or other business structure.</p>
