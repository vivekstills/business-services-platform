  ...
  return (
    <PolicyLayout title="About Us">
        ...
        {[
          ...
          <div key={item.title} className="card-hover-warm flex gap-4 p-4 rounded-xl bg-white border border-gray-200">
            ...
            <div>
              ...
              <div className="text-[calc(14px+3pt)] text-gray-500">{item.desc}</div>
            </div>
          </div>
        ))}
      </div>
      <div className="mt-10 p-6 bg-blue-50 border border-blue-100 rounded-2xl">
        ...
        <p className="text-gray-600 text-[calc(14px+3pt)] mb-4">Explore our services or reach out for a personalised consultation.</p>
