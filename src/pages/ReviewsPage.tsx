  ...
  return (
    <PolicyLayout title="Client Reviews">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {REVIEWS.map((r, i) => (
          ...
          >
            ...
            <p className="text-gray-600 text-[calc(15px+1.5pt)] leading-relaxed mb-4">&ldquo;{r.text}&rdquo;</p>
            <div>
              <div className="font-semibold text-gray-900">{r.name}</div>
              <div className="text-[calc(13px+1.5pt)] text-gray-500">{r.role}</div>
            </div>
          </motion.div>
        ))}
      </div>
      <div className="mt-12 p-6 bg-blue-50 border border-blue-100 rounded-2xl text-center">
        ...
        <p className="text-[calc(14px+1.5pt)] text-gray-500 mb-4">We'd love to hear from you. Email your review to <a href="mailto:enquiry@mridhuvassociates.com" className="text-blue-600 font-semibold">enquiry@mridhuvassociates.com</a></p>
