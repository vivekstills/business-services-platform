          ...
          >
            ...
            <div className="flex items-center gap-3 px-5 py-4 bg-gradient-to-r from-emerald-600 to-teal-600 relative">
              ...
              <div className="flex-1">
                <div className="text-white font-bold text-[calc(15px+2pt)] leading-tight">Need Help?</div>
                <div className="flex items-center gap-1.5 mt-0.5">
                  <div className="w-1.5 h-1.5 rounded-full bg-emerald-300 animate-pulse" />
                  <span className="text-emerald-100 text-[calc(12px+2pt)]">Expert available now</span>
                </div>
              </div>
              <button
                onClick={handleClose}
            ...
            {step === 'chat' && (
              <div className="p-5 space-y-4">
                <div className="flex gap-2.5">
                  ...
                  <div className="bg-gray-50 border border-gray-100 rounded-2xl rounded-bl-sm px-4 py-3 text-[calc(14px+2pt)] text-gray-700 leading-relaxed">
                    {message}
                  </div>
                </div>
                ...
                <div className="flex gap-2 pt-1">
                  <button
                    ...
                    className="flex-1 py-2.5 rounded-xl bg-emerald-600 text-white font-semibold text-[calc(14px+2pt)] hover:bg-emerald-700 transition-colors"
                  >
                    Yes, I need help
                  </button>
                  <button
                    onClick={handleClose}
                    className="px-4 py-2.5 rounded-xl border border-gray-200 text-gray-500 text-[calc(14px+2pt)] hover:bg-gray-50 transition-colors"
                  >
                    Later
                  </button>
                </div>
            ...
            {step === 'form' && (
              <form onSubmit={handleSubmit} className="p-5 space-y-3">
                <div className="flex gap-2.5 mb-4">
                  ...
                  <div className="bg-gray-50 border border-gray-100 rounded-2xl rounded-bl-sm px-4 py-3 text-[calc(13px+2pt)] text-gray-600 leading-relaxed">
                ...
                <div>
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-[calc(14px+2pt)] focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100 transition-all"
                  />
                </div>
                <div>
                  <input
                ...
                <div>
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-[calc(14px+2pt)] bg-gray-50 focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100 transition-all"
                  />
                </div>

                {error && (
                  <p className="text-red-500 text-[calc(13px+2pt)]">{error}</p>
                )}

                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full py-2.5 rounded-xl bg-emerald-600 text-white font-semibold text-[calc(14px+2pt)] hover:bg-emerald-700 transition-colors disabled:opacity-60 flex items-center justify-center gap-2"
                >
                  {submitting ? (
                ...
                <p className="text-[calc(11px+2pt)] text-gray-400 text-center">
            ...
            {step === 'success' && (
              <div className="p-6 text-center space-y-3">
                ...
                <button
                  onClick={handleClose}
                  className="mt-2 px-6 py-2 rounded-xl border border-gray-200 text-gray-600 text-[calc(14px+2pt)] hover:bg-gray-50 transition-colors"
                >
                  Close
                </button>
              </div>
