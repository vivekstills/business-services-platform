...
function CategoryBadge({ cat }: { cat: string }) {
  ...
  return <span className={`inline-flex items-center px-2 py-0.5 rounded-md text-[11px] font-semibold border ${cls}`}>{cat}</span>;
}
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-[11px] text-gray-400 mt-1">URL: /articles/{draft.slug || 'slug'}</p>
            </div>
            <div>
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1.5">
                    ...
                    <span className={`text-[11px] font-semibold ${article.published ? 'text-green-600' : 'text-yellow-600'}`}>
