        ...
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <div className="flex-1 max-w-[680px]">
            ...
            >
              ...
              <p className="text-[calc(17px+3pt)] leading-[1.7] text-[#A0A0A0] mb-6">
                A Private Limited Company is the most popular legal structure for businesses in India. It offers limited liability protection to its shareholders, ability to raise equity funds, and separate legal entity status. This structure is ideal for startups and growing businesses looking to scale operations.
              </p>
              ...
              <ul className="space-y-3 mb-8 ml-1">
                {[
                  ...
                  <li key={i} className="flex items-start gap-3 text-[calc(17px+3pt)] leading-[1.7] text-[#A0A0A0]">
              ...
              <div className="bg-[#111111] border border-[#1A1A1A] rounded-lg p-6 mb-8">
                ...
                <ul className="space-y-2 mb-6">
                  <li className="text-[#A0A0A0] text-[calc(16px+3pt)]">• PAN Card (Mandatory for Indians)</li>
                  <li className="text-[#A0A0A0] text-[calc(16px+3pt)]">• Passport (Mandatory for Foreigners)</li>
                  <li className="text-[#A0A0A0] text-[calc(16px+3pt)]">• Voter ID / Driving License / Passport</li>
                  <li className="text-[#A0A0A0] text-[calc(16px+3pt)]">• Latest Bank Statement / Electricity Bill</li>
                </ul>
                <h3 className="text-lg font-medium text-white mb-4">For Registered Office</h3>
                <ul className="space-y-2">
                  <li className="text-[#A0A0A0] text-[calc(16px+3pt)]">• Latest Electricity Bill / Gas Bill</li>
                  <li className="text-[#A0A0A0] text-[calc(16px+3pt)]">• Notarized Rental Agreement (if rented)</li>
                  <li className="text-[#A0A0A0] text-[calc(16px+3pt)]">• No Objection Certificate (NOC) from owner</li>
                </ul>
              </div>
              ...
              <ol className="space-y-6 mb-8 relative border-l border-[#1A1A1A] ml-3 pl-8">
                {[
                  ...
                  <li key={i} className="relative">
                    <span className="absolute -left-[39px] top-1.5 w-5 h-5 rounded-full bg-[#1A1A1A] border border-[#333333] flex items-center justify-center text-[calc(10px+3pt)] text-white font-medium">
                      {i + 1}
                    </span>
