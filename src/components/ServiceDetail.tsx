        ...
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <div className="flex-1 max-w-[680px]">
            ...
            <motion.div
              ...
              className="space-y-8"
            >
              <div className="text-[16px] leading-[1.7] text-[#A0A0A0] whitespace-pre-line">
                {service.content}
              </div>
            ...
            <div className="sticky top-32">
              ...
              >
                ...
                <div className="space-y-1.5">
                  <label className="block text-[13px] font-medium text-[#E5E7EB]">
                    Full Name
                  </label>
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className={`w-full h-[44px] bg-[#030712] border rounded-md pl-9 pr-3 text-[14px] text-white placeholder-[#6B7280] focus:outline-none transition-all duration-200 ${
                        errors.name
                  ...
                  {errors.name && (
                    <p className="text-[11px] text-[#FCA5A5] mt-0.5">{errors.name}</p>
                  )}
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  {errors.email && (
                    <p className="text-[11px] text-[#FCA5A5] mt-0.5">{errors.email}</p>
                  )}
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  {errors.phone && (
                    <p className="text-[11px] text-[#FCA5A5] mt-0.5">{errors.phone}</p>
                  )}
                </div>

                <button
                  type="submit"
                  className="w-full h-[44px] mt-2 bg-white text-black text-[14px] font-semibold rounded-md hover:bg-gray-100 transition-colors flex items-center justify-center gap-2"
                >
                  {isSubmitted ? (
                    <>
