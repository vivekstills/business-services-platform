            ...
            >
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[calc(13px+3pt)] text-gray-500 leading-relaxed">{cat.description}</p>
                </div>
                <div className="mt-5 flex items-center gap-1.5 text-[calc(12px+3pt)] font-semibold text-gray-400 group-hover:text-blue-600 transition-colors">
