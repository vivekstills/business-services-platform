        ...
        <AnimatePresence>
          {!isOpen && showBadge && (
            <motion.div
              ...
              className="absolute -top-10 -left-28 bg-gray-900 text-white text-[calc(12px+2pt)] font-medium px-3 py-1.5 rounded-full whitespace-nowrap shadow-lg"
            >
              💬 Ask us anything!
          ...
          >
            ...
            <div className="flex items-center gap-3 px-4 py-3.5 bg-gradient-to-r from-blue-600 to-blue-700 flex-shrink-0">
              ...
              <div className="flex-1">
                <div className="text-white font-bold text-[calc(14px+2pt)] leading-tight">Mridhuv Assistant</div>
                <div className="flex items-center gap-1.5 mt-0.5">
                  <div className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
                  <span className="text-blue-200 text-[calc(11px+2pt)]">Online · Replies instantly</span>
                </div>
              </div>
            ...
            <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3 bg-gray-50/50">
              {messages.map((msg) => (
                ...
                >
                  ...
                  <div
                    className={`max-w-[78%] px-3.5 py-2.5 rounded-2xl text-[calc(13.5px+2pt)] leading-relaxed whitespace-pre-line ${
                      msg.from === 'user'
              ...
              <div className="px-4 py-2 flex gap-2 flex-wrap border-t border-gray-100 bg-white flex-shrink-0">
                {QUICK_REPLIES.map((qr) => (
                  <button
                    ...
                    className="text-[calc(11.5px+2pt)] font-medium text-blue-700 bg-blue-50 hover:bg-blue-100 border border-blue-100 rounded-full px-3 py-1 transition-colors"
                  >
                    {qr.label}
                  </button>
                ))}
            ...
            >
              <input
                ...
                className="flex-1 h-9 rounded-xl border border-gray-200 px-3.5 text-[calc(13.5px+2pt)] text-gray-700 placeholder-gray-300 focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100 transition-all bg-gray-50"
              />
              <button
                type="submit"
