          ...
          >
            ...
            <div className="flex items-center gap-3 px-4 py-3.5 bg-gradient-to-r from-blue-600 to-blue-700 flex-shrink-0">
              ...
              <div className="flex-1">
                <div className="text-white font-bold text-[calc(14px+3pt)] leading-tight">Mridhuv Assistant</div>
                <div className="flex items-center gap-1.5 mt-0.5">
                  <div className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
                  <span className="text-blue-200 text-[calc(11px+3pt)]">Online · Replies instantly</span>
                </div>
              </div>
            ...
            <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3 bg-gray-50/50">
              {messages.map((msg) => (
                ...
                >
                  ...
                  <div
                    className={`max-w-[78%] px-3.5 py-2.5 rounded-2xl text-[calc(13.5px+3pt)] leading-relaxed whitespace-pre-line ${
                      msg.from === 'user'
