/**
 * Syncs articles from scripts/batch4-sources/*.md (same 5 slugs as batch 5 pipeline).
 * Run: BATCH_RAW_DIR=batch4-raw BATCH_OUT_DIR=batch4-sources node scripts/build-batch5-sources.mjs
 * Then: node scripts/sync-batch4-to-content.mjs
 */
import fs from 'fs';
...
const srcDir = path.join(__dirname, 'batch4-sources');
