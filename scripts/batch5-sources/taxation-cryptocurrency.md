...
TDS deducted under Section 194S is visible in Form 26AS and the Annual Information Statement (AIS). It is a credit against the final tax liability computed in the ITR. For taxpayers in a tax loss position (VDA losses that cannot be offset), the TDS represents a cash outflow with no immediate refund - since VDA losses cannot be carried forward to offset future gains.
