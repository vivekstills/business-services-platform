#!/usr/bin/env node
/**
 * Patches data/content.json + public/content.json for Import Export compliance Batch 8.
 * Run: node scripts/patch-import-export-batch8.mjs
 */
...
const BATCH_DIR = path.join(ROOT, 'tmp/import-export-batch8');

const IDS = ['icegate-registration', 'iec-modification', 'import-export-code'];
...
console.log('Done.', IDS.length, 'import-export service pages.');
