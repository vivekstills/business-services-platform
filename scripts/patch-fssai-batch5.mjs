#!/usr/bin/env node
/**
 * Patches data/content.json + public/content.json for FSSAI Batch 5 About content.
 * Run: node scripts/patch-fssai-batch5.mjs
 */
...
const BATCH_DIR = path.join(ROOT, 'tmp/fssai-batch5');
...
console.log('Done.', IDS.length, 'FSSAI services.');
