#!/usr/bin/env node
/**
 * Patches data/content.json + public/content.json for Government Registrations Batch 6.
 * Run: node scripts/patch-gov-reg-batch6.mjs
 */
...
const BATCH_DIR = path.join(ROOT, 'tmp/gov-reg-batch6');
...
console.log('Done.', IDS.length, 'government registration services.');
