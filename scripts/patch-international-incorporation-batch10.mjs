#!/usr/bin/env node
/**
 * Patches data/content.json + public/content.json for International Incorporation (Batch 10).
 * Prereq: tmp/international-incorporation-batch10/<id>.md for each id.
 * Run: node scripts/patch-international-incorporation-batch10.mjs
 */
...
const BATCH_DIR = path.join(ROOT, 'tmp/international-incorporation-batch10');
...
console.log('Done.', IDS.length, 'international incorporation service pages.');
